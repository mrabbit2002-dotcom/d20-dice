...
begin
  ...
  if not FileExists(ObsExe) then MsgBox('OBS Studio was not detected in the default folder. You can select your OBS Studio folder on the next screen.', mbInformation, MB_OK);
  Result := True;
end;
